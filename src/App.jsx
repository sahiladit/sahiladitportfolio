  ...
  return (
    <div>
      ...
      <div id="page2" className="h-screen w-screen flex flex-col md:flex-col items-center justify-center text-center px-6 md:px-16">
        ...
        <Terminal />
        <div className='links flex items-center md:items-center justify-around absolute p-5 md:p-0 md:text-4xl text-2xl h-12 w-1/2 rounded-4xl top-300 bg-[#ffffffbd]  md:top-335 md:w-1/3 md:h-16'>
