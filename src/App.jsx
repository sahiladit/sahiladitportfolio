  ...
  return (
    <div>
      ...
      <div id="page2" className="h-screen w-screen flex flex-col md:flex-col items-center justify-center text-center px-6 md:px-16">
        ...
        <Terminal />
        <div className='links flex md:scale-100 scale-150 items-center z-10  md:items-center justify-around relative p-5 md:p-0 md:text-4xl text-2xl h-12 w-60 rounded-4xl -top-1/4 bg-[#ffffffbd] md:-top-1/4 md:w-1/3'>
          ...
          <a href="https://medium.com/@sahiladit" target='_blank' className='z-10 md:top-0 -top-1 relative'><i class="fa-brands fa-medium"></i></a>
        </div>
      </div>
