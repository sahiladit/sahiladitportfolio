...
const Terminal = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen w-screen -top-24 relative overflow-hidden" style={{ overflow: 'hidden' }}>
      ...
      <motion.div
        ...
        className="relative  w-full  max-w-2xl border border-green-500 p-4 m-10 rounded-lg shadow-lg   text-green-400 font-mono"
      >
